...
const Landing = () => {
  ...
  const formFields = [
    ...
    { placeholder: 'Role', type: 'select', icon: <WorkOutline />, required: true, options: [
    ...
    { placeholder: 'Degree Type', type: 'text', icon: <Grade />, required: true },
    ...
    { placeholder: 'Year of Passing', type: 'text', icon: <CalendarToday />, required: true },
  ];
  ...
  return (
    <div className="min-h-screen h-screen w-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="hidden md:flex w-full md:w-[65%] flex-col relative pt-4 px-2 xs:px-4 sm:px-6 lg:px-12 bg-gradient-to-br from-[#311188]/10 to-[#0A081E]/30 min-w-0 overflow-y-auto max-h-[50vh] md:max-h-none md:h-screen transition-all duration-500">
        <div className="w-full flex flex-col h-full justify-start pb-24 min-w-0">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-0 mb-1">
              ...
              <img src={SignavoxLogo} alt="Signavox Logo" className="w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 lg:w-11 lg:h-11 align-middle inline-block mt-2 xs:mt-4"/>
          ...
          {/* Footer Section at the bottom of the left content */}
          <div className="static mt-12 bottom-2 md:bottom-4 left-2 md:left-6 right-2 md:right-6 text-xs md:text-sm text-purple-200/60 text-center md:text-left z-10">
          ...
          <form className="flex-1 p-2 xs:p-4 flex flex-col gap-4 overflow-y-auto overflow-x-hidden custom-scrollbar" onSubmit={handleRegister}>
            ...
            <div className="space-y-2 xs:space-y-4">
              ...
              <motion.div
                initial={{ opacity: 0, x: 30 }}
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.5 + formFields.length * 0.1, duration: 0.6 }}
                className="group"
              >
                <TextField
                  fullWidth
              ...
              >
                <FormControl component="fieldset" className="w-full">
                  <FormLabel component="legend" className="text-[#311188] font-semibold mb-2 text-base font-spoof">
                  ...
                  <RadioGroup
                    ...
                    className="justify-start space-x-4 xs:space-x-8"
                  >
                    <FormControlLabel
                      value="yes"
                      control={
                  ...
                  {hasExperience === 'yes' && (
                    ...
                    >
                      <Typography variant="h6" className="text-[#311188] font-semibold mt-2 xs:mt-4 mb-2 xs:mb-3 font-spoof text-base xs:text-lg">
